                ...
                <div className="font-poppins md:mt-28 max-w-4xl mx-auto">
                    ...
                    <div className="bagian-info-user bg-white p-2 rounded-lg shadow-lg mb-8 relative">
                        ...
                        <div className=" ">
                            ...
                            <div></div>
                            <div className="absolute right-2 top-2 rounded-lg p-1 bg-[#F5F4F4] hover:bg-red-500 text-xs group cursor-pointer">
                            ...
                            <button className="bg-emerald-500 py-1 px-2 rounded-lg text-white mb-2 mt-4 ml-2">Save</button>
                        </div>
                    </div>
                                    ...
                                    len ? (
                                        <div className="the-table mx-auto">
                                            ...
                                            <div className="input-number mb-4">
                                                ...
                                                <span className="text-sm"> of {len} total activity</span>
                                            </div>
